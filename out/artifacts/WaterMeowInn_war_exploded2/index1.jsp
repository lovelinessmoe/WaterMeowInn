...
<div id="main">
    ...
    <form name=alipayment action=PayServlet method=post
          target="_blank">
    ...
    <form name=tradequery action=QueryOrderServlet method=post
          target="_blank">
    ...
    <form name=traderefund action=RefundOrderServlet method=post
          target="_blank">
    ...
    <form name=traderefundquery
          action=QueryRefundServlet method=post
          target="_blank">
    ...
    <form name=tradeclose action=CloseOrderServlet method=post
          target="_blank">
